$(document).on("ready",function(){
	...
	var socket=io.connect();//comunicarse con el server
	...
	$("#mapa").on("click",function(){
		...
		var bolitas="<div id='bolita"+i+"'type='bolita'class='bolita' name='bolita' style='background-color:"+posBol.color+";left:"+posBol.left+"px;top:"+posBol.top+"px;'>"+i+"</div>";
	...
	$("#boton").on("click",function(){
		...
		var obj={
			jugadorPrincipal:"<div id='"+objJugador.id+"' class='player' type='player' name='"+objJugador.id+"' style='background-color:"+objJugador.color+";border:3px solid "+objJugador.borde+"'>"+objJugador.id+"</div>",
